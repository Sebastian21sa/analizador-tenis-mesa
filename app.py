...
def health(): 
    """Punto final de la API que verifica si los modelos están cargados correctamente y devuelve un estado de salud."""
    try: 
        return jsonify({ 
            'status': 'ok', 
            ...
            'modelo_identificador': 'cargado' if modelo_identificador is not None else 'no disponible', 
            }), 200 
